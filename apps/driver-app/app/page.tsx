...
export default function DriverPage() {
  ...
  const { routeData, alerts, loading, error, lastRefreshed, refresh } =
    useRouteData(origin, destination);
    ...
    <div style={{
        ...
        {routeData && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, flex: 1, minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, minWidth: 0 }}>
              ...
              <span style={{ color: '#cbd5e1', fontSize: 13, fontWeight: 500, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                {routeData.origin}
              </span>
      ...
      <div style={{ flex: 1, display: 'flex', minHeight: 0 }}>
        ...
        <div style={{ flex: 1, position: 'relative', minWidth: 0 }}>
          ...
          {/* Route Selector floats over map */}
          <RouteSelector
